...
export class Myc10EmpTableComponent implements OnInit {
  ...
  empList = [
    ...
    {eid: 102, ename:'name2', salary: 12344, birthday: 1000, gender: 0, politic: 20 },
    {eid: 103, ename:'name3', salary: 5000.12567, birthday: 1000*3600*24, gender: 1, politic: 30 },
    {eid: 104, ename:'name4', salary: 800, birthday: 1000*3600*24*365, gender: 0, politic: 20 },
  ];
